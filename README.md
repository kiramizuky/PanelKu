...
- MongoDB 7
- Redis 7
- Linux (Debian/Ubuntu/Armbian) for full terminal/PTY features
...
### One-Click Server Install (Debian/Ubuntu/Armbian)
...
| Phase 2 | 🔜 | Docker, Websites, Domains, SSL |
| Phase 3 | 🔜 | Database Management, Backup, Cron |
| Phase 4 | 🔜 | Firewall, WAF, Security, Notifications |
| Phase 5 | 🔜 | Git Deploy, Auto Update, Plugin Marketplace |
